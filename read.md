...
Backend API (Go) - RESTful API for geofencing and vehicle tracking
Real-time Alert System (Go) - Alert notification system (WebSocket or alternative approach)
Frontend Application (React) - Web interface to interact with the system and receive live alerts
...
Broadcasts real-time alerts when geofence events occur
